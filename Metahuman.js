...
class Metahuman extends React.Component {
  constructor(props) {
    super(props);
    ...
    return (
      <div className="App">
        ...
        <div className="meta-container">
          <div
            className="metamessages-container"
          ...
          <form onSubmit={this.handleSubmit} className="input-container-meta">
            <input
              type="text"
              value={userInput}
            ...
            />
            <button className="submit-meta" type="submit">
              Send
            </button>
          </form>
        </div>
